...
frappe.ui.form.on('Zenoti Center', {
	refresh(frm) {
		frm.add_custom_button('Employees', function() {
			frappe.call({
		...
		frm.add_custom_button('Customers', function() {
			frappe.call({
				method:"ecommerce_integrations.zenoti.doctype.zenoti_center.zenoti_center.sync",
				args:{
					center: frm.doc.name,
		...
		frm.add_custom_button('Items', function() {
			frappe.call({
				method:"ecommerce_integrations.zenoti.doctype.zenoti_center.zenoti_center.sync",
				args:{
					center: frm.doc.name,
		...
		frm.add_custom_button('Categories', function() {
			frappe.call({
				method:"ecommerce_integrations.zenoti.doctype.zenoti_center.zenoti_center.sync",
				args:{
					center: frm.doc.name,
